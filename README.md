...
1. Create a new folder with holo.json and the respective MDX files
...
2. Run `npx @born4rhell/holo setup` to setup the repo in local

3. Run `npx @born4rhell/holo dev` to run the website in http://localhost:3000
